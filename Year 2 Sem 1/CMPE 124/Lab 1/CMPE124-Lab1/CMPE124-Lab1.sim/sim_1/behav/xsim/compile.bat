...
REM
REM Generated by Vivado on Sun Oct 12 01:25:14 -0700 2025
...
echo "xvlog --incr --relax -prj tb3_1_vlog.prj"
call xvlog  --incr --relax -prj tb3_1_vlog.prj -log xvlog.log
