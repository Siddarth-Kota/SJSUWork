...
HD_PWD='C:/Users/kotas/Downloads/Sid Stuff/SJSUWork/CMPE 124/Lab 2/CMPE124-Lab2/CMPE124-Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fadder1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fadder1bit.tcl
