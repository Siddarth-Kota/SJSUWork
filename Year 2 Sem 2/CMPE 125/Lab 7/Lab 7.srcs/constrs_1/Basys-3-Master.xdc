...
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports {F[0]}]
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports {F[1]}]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports {F[2]}]
...
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports {overflow}]
...
#set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {Y}]
